...
int main() {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Hello Projections!", NULL, NULL);
    ...
    data = stbi_load("data/310697.png", &width, &height, &nrChannels, 0);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        view = glm::rotate(view, glm::radians(25.f), glm::vec3(1.0f, 0.0f, 0.0f));
